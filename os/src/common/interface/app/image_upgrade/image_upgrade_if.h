...
typedef enum
{
    ...
    /** Apps read-write configuration keys image section. */
    /* 
     * Apps P0 will copy this image section from the boot image bank
     * to the other image bank whilst handling the ImageUpgradeSwapTry() trap.
     */
    ...
    /** Apps Debug Partition image section. */
    /* NOTE: this image section cannot be upgraded using image upgrade
     * traps. 
     * Apps P0 will not copy this image section from the boot image bank
     * to the other image bank.
     */
    IMAGE_SECTION_APPS_DEBUG_PARTITION         = 0xe,

    /** Voice model image section */
    /* NOTE: this image section cannot be upgraded using image upgrade
     * traps. 
     * Apps P0 will copy this image section from the boot image bank
     * to the other image bank whilst handling the ImageUpgradeSwapTry() trap.
     */
    /* Second note: This is a virtual section - it doesn't exist on the
     * physical flash, it's an invention of the flash_header layer
     */
    IMAGE_SECTION_APPS_VMODEL_PARTITION        = 0xf,
