...
class dfu_file_generator():
    ...
    # Create an xuv file containing the footer from all partitions apart from rw_config 
    # to go in the DFU file
    def create_footer(self):
        ...
        # We use all partitions apart from rw_config to go in the DFU file for signing, 
        # but swap the endian-ness and concatonate into a single file to get it working with
