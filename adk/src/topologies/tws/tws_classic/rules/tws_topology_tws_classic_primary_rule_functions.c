...
rule_action_t ruleTwsTopClassicPriFindRole(void)
{
    ...
    if (TwsTopology_PeerProfilesToRetain() != 0 && TwsTopology_GetRole() == tws_topology_role_primary)
    {
        DEBUG_LOG("ruleTwsTopClassicPriFindRole, ignore as already has role as primary and peer profile retention enabled.");
        return rule_action_ignore;
    }
...
rule_action_t ruleTwsTopClassicPriNoRoleIdle(void)
{
         ...
         && appPhyStateGetState() == PHY_STATE_IN_CASE)
    {
        ...
        DEBUG_LOG("ruleTwsTopClassicPriNoRoleIdle, ignore as profile retention enabled");
        return rule_action_ignore;
    }
...
rule_action_t ruleTwsTopClassicPriPeerLostFindRole(void)
{
    ...
    {
        DEBUG_LOG("ruleTwsTopClassicPriPeerLostFindRole, ignore as in case and peer profile retention not enabled");
        return rule_action_ignore;
    }
...
rule_action_t ruleTwsTopClassicPriEnableConnectableHandset(void)
{
    ...
    {
        DEBUG_LOG("ruleTwsTopClassicPriEnableConnectableHandset, ignore as in case and handset profile retention not enabled");
        return rule_action_ignore;
    }
...
rule_action_t ruleTwsTopClassicPriHandoverStart(void)
{
    ...
    {
        /* ToDo: Need to decide on the scope to clear it. */
        DEBUG_LOG("ruleTwsTopClassicPriHandoverStart, Ignored as profile retention enabled ");
        return rule_action_ignore;
    }
