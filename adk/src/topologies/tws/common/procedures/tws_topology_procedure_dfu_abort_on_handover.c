...
/*
 * Disable the Handover abort procedures both for legacy scheme (VMCSA-3385) &
 * new scheme (VMCSA-4313).
 */
#if 0
...
/* ToDo: Check if the include dependency be burried under dfu.h */
                                        ...
                                        Message goal_data)
{
    ...
    if (UpgradeIsInProgress())
    {
        ...
        Dfu_SetDfuAbortOnHandoverState(TRUE);
    }
