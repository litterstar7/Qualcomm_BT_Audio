...
/*! Primary address parameter, with no panic */
extern const SET_ADDRESS_TYPE_T proc_set_address_primary_no_panic;
/*! Macro to access primary address parameter as a goal_data parameter, without a panic */
#define PROC_SET_ADDRESS_TYPE_DATA_PRIMARY_NO_PANIC  ((Message)&proc_set_address_primary_no_panic)
