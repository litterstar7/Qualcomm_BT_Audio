                                        ...
                                        Message goal_data)
{
    ...
    HandsetService_DisconnectRequest(TwsTopProcDisconnectHandsetGetTask(), &handset_addr, 0);
...
static void twsTopology_ProcDisconnectHandsetHandleHandsetDisconnectCfm(const HANDSET_SERVICE_DISCONNECT_CFM_T *cfm)
{
    ...
    if (le_handset)
    {
        HandsetService_DisconnectTpAddrRequest(TwsTopProcDisconnectHandsetGetTask(), &le_handset_tpaddr, 0);
    }
    else
    {
        twsTopology_ProcDisconnectHandsetResetProc();
