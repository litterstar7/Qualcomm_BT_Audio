                                                              ...
                                                              Message goal_data)
{
    ...
    DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureAllowHandsetConnectStart allow %d", param->enable);
...
static void HeadsetTopology_ProcedureAllowHandsetConnectCancel(procedure_cancel_cfm_func_t proc_cancel_cfm_fn)
{
    DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureAllowHandsetConnectCancel");
