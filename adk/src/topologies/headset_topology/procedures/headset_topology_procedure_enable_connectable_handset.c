                                                                   ...
                                                                   Message goal_data)
{
    ...
    if (params->enable)
    {
        DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureEnableConnectableHandsetStart ENABLE");

        HandsetService_ConnectableRequest(HeadsetTopProcEnableConnectableHandsetGetTask());
    }
    else
    {
        DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureEnableConnectableHandsetStart DISABLE");
...
static void HeadsetTopology_ProcedureEnableConnectableHandsetCancel(procedure_cancel_cfm_func_t proc_cancel_cfm_fn)
{
    ...
    if (td->params.enable)
    {
        DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureEnableConnectableHandsetCancel cancel enable");

        HandsetService_CancelConnectableRequest(HeadsetTopProcEnableConnectableHandsetGetTask());
    }
    else
    {
        DEBUG_LOG_VERBOSE("HeadsetTopology_ProcedureEnableConnectableHandsetCancel cancel disable");
