...
static void keySync_AddDeviceAttributes(bdaddr* bd_addr)
{
    ...
    BtDevice_SetSupportedProfile((const bdaddr *)bd_addr, DEVICE_PROFILE_AVRCP|DEVICE_PROFILE_A2DP|DEVICE_PROFILE_HFP);
    BtDevice_SetLastConnectedProfiles((const bdaddr *)bd_addr, DEVICE_PROFILE_AVRCP|DEVICE_PROFILE_A2DP|DEVICE_PROFILE_HFP, TRUE);
}
