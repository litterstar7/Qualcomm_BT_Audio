...
/*! This config controls if Avrcp Absolute volume suppression is enabled or not
       after AVRCP state machine has entered 'connected' state. */
#ifdef DISABLE_ABSOLUTE_VOLUME_SUPRESSION
#define appConfigAvrcpAbsoluteVolumeSuppressionEnabled() FALSE
#else
#define appConfigAvrcpAbsoluteVolumeSuppressionEnabled() TRUE
#endif
