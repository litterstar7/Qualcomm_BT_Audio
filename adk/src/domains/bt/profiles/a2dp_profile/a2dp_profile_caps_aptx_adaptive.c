...
#define APTX_AD_MIN_LL_TTP_2G4  (uint8)(0x2)   /* 5G TTP + 10 (2*5) */ 
#define APTX_AD_MAX_LL_TTP_5G   (uint8)(0x50)  /* base TTP + 25 */ 
#define APTX_AD_MAX_LL_TTP_2G4  (uint8)(0x2)   /* Max LL 5G TTP + 10 */ 
#endif
...
static void updateCapabilityBasedOnTheAdvertiseOption(aptx_ad_advertise_options_t advertise_option)
{
    switch (advertise_option)
    {
        case aptx_ad_advertise_r2:
            ...
            setSupportedFeatures(aptx_ad_default_features | aptx_ad_2_1_kernel_support | aptx_ad_twm_support);
#else
