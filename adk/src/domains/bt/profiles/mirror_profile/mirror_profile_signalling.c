...
{
    mirror_profile_a2dp_t *a2dp_state = MirrorProfile_GetA2dpState();
    MIRROR_LOG("mirrorProfile_HandleA2dpStreamContext a2dp_state:%d ind_state:%d q2q|seid:%02x", a2dp_state->state, context->audio_state, (context->q2q_mode<<4)|context->seid);
