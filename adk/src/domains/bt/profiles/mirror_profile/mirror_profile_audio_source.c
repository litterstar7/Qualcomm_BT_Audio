...
static void mirrorProfile_GetConnectParameters(a2dp_connect_parameters_t *params)
{
...
static void mirrorProfile_GetDisconnectParameters(a2dp_disconnect_parameters_t *params)
{
    mirror_profile_a2dp_t *a2dp_state = MirrorProfile_GetA2dpState();
...
static void mirrorProfile_StoreAudioConnectParameters(const a2dp_connect_parameters_t *params)
{
