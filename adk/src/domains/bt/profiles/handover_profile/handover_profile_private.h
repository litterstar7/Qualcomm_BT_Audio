...
/*! Returns Protocol message ID from data*/
#define handoverProfile_GetMessageId(data) ((data)[0])
...
} HANDOVER_PROFILE_VERSION_IND_T;
...
/*! 
    ...
    \param[in] messageid Expected Message id. If HANDOVER_PROTOCOL_INVALID_MSG_ID is provided,
                         this function returns on first message received.
...
/*!
    \brief Send handover protocol version indication to peer.
    \return status
*/
