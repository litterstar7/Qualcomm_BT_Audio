...
enum
{
    ...
    AV_SEID_APTXHD_SNK = 0x05,              /*!< APTX HD Sink endpoint for standard handsets */
    AV_SEID_APTX_ADAPTIVE_SNK = 0x06,       /*!< APTX adaptive Sink endpoint for standard handsets (placeholder) */

    AV_SEID_SBC_MONO_TWS_SRC = 0x07,        /*!< Mono TTP SBC Source endpoint for earbud forwarding TWS */
    AV_SEID_AAC_STEREO_TWS_SRC = 0x08,      /*!< Stereo TTP AAC Source endpoint for earbud forwarding TWS */
    AV_SEID_APTX_MONO_TWS_SRC = 0x09,       /*!< Mono TTP APTX Source endpoint for earbud forwarding TWS  */
    AV_SEID_APTX_ADAPTIVE_TWS_SRC = 0x0A,   /*!< TTP APTX adaptive Source endpoint for earbud forwarding TWS (placeholder) */

    AV_SEID_SBC_MONO_TWS_SNK = 0x0B,        /*!< Mono TTP SBC Sink endpoint for peer earbud receiving TWS */
    AV_SEID_AAC_STEREO_TWS_SNK = 0x0C,      /*!< Stereo TTP AAC Sink endpoint for peer earbud receiving TWS */
    AV_SEID_APTX_MONO_TWS_SNK = 0x0D,       /*!< Mono TTP APTX Sink endpoint for peer earbud receiving TWS & TWS+ Handsets */
...
extern const sep_config_type av_aptxhd_snk_sep;
...
/*! \brief Has device associated with av_instance started streaming

    \param  av_instance The instance to query

    \return TRUE if the device has started streaming A2DP
*/
...
/*! \brief Is the device associated with av_instance cpnnected
...
/*! \brief Get the current play status of specific av_instance
