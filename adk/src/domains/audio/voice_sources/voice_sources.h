...
/*! \brief Voice Sources UI Provider contexts
    \note This enumerated type must be maintained in order of ascending priority.
          A Voice Source which has been disconnected has the lowest prioirity in
          audio routing, whereas an voice source that is in a call with audio active,
          has the highest priority. */
typedef enum
{
    context_voice_disconnected,
    context_voice_connected,
    context_voice_ringing_outgoing,
    context_voice_ringing_incoming,
    context_voice_call_audio_inactive,
    context_voice_call_audio_active,
