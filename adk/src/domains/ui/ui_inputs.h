...
#define FOREACH_UI_INPUT(UI_INPUT) \
    ...
    UI_INPUT(ui_input_av_volume_down_stop) \
    UI_INPUT(ui_input_av_volume_up_stop) \
    ...
    UI_INPUT(ui_input_hfp_volume_up) \
    UI_INPUT(ui_input_hfp_volume_down) \
    UI_INPUT(ui_input_av_volume_up) \
    UI_INPUT(ui_input_av_volume_down) \
