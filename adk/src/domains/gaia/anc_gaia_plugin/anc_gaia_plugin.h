...
#define ANC_GAIA_ADAPTIVE_ANC_STATE_NOTIFICATION_PAYLOAD_LENGTH 0x02
#define ANC_GAIA_ADAPTIVE_ANC_FF_GAIN_NOTIFICATION_PAYLOAD_LENGTH 0x02
...
#define ANC_GAIA_AANC_DISABLE 0x00
#define ANC_GAIA_AANC_ENABLE 0x01

#define ANC_GAIA_LEFT_DEVICE 0x00
#define ANC_GAIA_RIGHT_DEVICE 0x01
#define ANC_GAIA_DEVICE_OFFSET 0
#define ANC_GAIA_AANC_FF_GAIN_OFFSET 1
#define ANC_GAIA_AANC_STATE_OFFSET 1
...
typedef enum
{
    ...
    /*! The device sends the adaptive anc state of both devices */
    anc_gaia_adaptive_anc_state_notification,
    /*! The device sends the adapted ff gain notification of both devices at specified intervals of time */
    anc_gaia_adapted_ff_gain_notification,
