                                             ...
                                             state_proxy_source source)
{
    ...
    if (event_type & (state_proxy_event_type_hfp_conn | state_proxy_event_type_hfp_discon |
                      state_proxy_event_type_avrcp_conn | state_proxy_event_type_avrcp_discon |
                      state_proxy_event_type_a2dp_conn | state_proxy_event_type_a2dp_discon))
    {
        stateProxy_UpdateConnectedSupportedProfiles();
    }
    return event_type;
