...
static void ama_Suspended(void);
...
static voice_ui_if_t ama_interface =
{
    ...
    .SelectVoiceAssistant = ama_SelectVoiceAssistant,
    {
        ...
        .CaptureSuspended = ama_Suspended,
#ifdef INCLUDE_WUW
        .WakeUpWordDetected = AmaAudio_WakeWordDetected,
        .LoadHotwordModelFile = Ama_LoadHotwordModelFile
#else
        .WakeUpWordDetected = NULL,
        .LoadHotwordModelFile= NULL
#endif /* INCLUDE_WUW */
    },
};
...
voice_ui_protected_if_t *Ama_GetVoiceUiProtectedInterface(void)
{
    ...
    return voice_ui_handle->va_protected_if;
}
...
void Ama_TransportDisconnected(void)
{
    ...
    DEBUG_LOG("AMA Transport Disconnect: %d", active_transport);
...
#endif
    if (active_transport != ama_transport_ble)
    {
        AmaProfile_SendDisconnectedInd();
    }
