...
static const ProtobufCFieldDescriptor response__field_descriptors[11] =
{
  ...
  },
  {
    ...
    offsetof(Response, u.firmware_component),
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    offsetof(Response, payload_case),
    offsetof(Response, u.firmware_information),
    &firmware_information__descriptor,
    NULL,
    0 | PROTOBUF_C_FIELD_FLAG_ONEOF,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
...
static const unsigned response__field_indices_by_name[] = {
  7,   /* field[7] = central_information */
  5,   /* field[5] = connection_details */
  6,   /* field[6] = device_configuration */
  2,   /* field[2] = device_information */
  8,   /* field[8] = dialog */
  0,   /* field[0] = error_code */
  1,   /* field[1] = firmware_component */
  3,   /* field[3] = firmware_information */
  10,   /* field[10] = locales */
  9,   /* field[9] = speech_provider */
  4,   /* field[4] = state */
};
static const ProtobufCIntRange response__number_ranges[6 + 1] =
{
  { 1, 0 },
  { 5, 3 },
  { 7, 4 },
...
const ProtobufCMessageDescriptor response__descriptor =
{
  ...
  6,  response__number_ranges,
  (ProtobufCMessageInit) response__init,
  NULL,NULL,NULL    /* reserved[123] */
};
static const ProtobufCFieldDescriptor control_envelope__field_descriptors[31] =
{
  {
    "command",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    offsetof(ControlEnvelope, payload_case),
    offsetof(ControlEnvelope, u.get_firmware_information),
    &get_firmware_information__descriptor,
    NULL,
    0 | PROTOBUF_C_FIELD_FLAG_ONEOF,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
...
static const unsigned control_envelope__field_indices_by_name[] = {
  ...
  30,   /* field[30] = get_central_information */
  8,   /* field[8] = get_device_configuration */
  7,   /* field[7] = get_device_information */
  26,   /* field[26] = get_firmware_information */
  23,   /* field[23] = get_locales */
  27,   /* field[27] = get_state */
  18,   /* field[18] = incoming_call */
  25,   /* field[25] = issue_media_control */
  ...
  1,   /* field[1] = response */
  24,   /* field[24] = set_locale */
  28,   /* field[28] = set_state */
  ...
  29,   /* field[29] = synchronize_state */
  13,   /* field[13] = update_device_information */
  15,   /* field[15] = upgrade_transport */
};
static const ProtobufCIntRange control_envelope__number_ranges[10 + 1] =
{
  { 1, 0 },
  { 9, 1 },
  { 20, 7 },
...
const ProtobufCMessageDescriptor control_envelope__descriptor =
{
  ...
  10,  control_envelope__number_ranges,
...
static const ProtobufCEnumValue command__enum_values_by_number[30] =
{
  ...
  { "GET_FIRMWARE_INFORMATION", "COMMAND__GET_FIRMWARE_INFORMATION", 90 },
...
{0, 0},{10, 1},{20, 6},{30, 14},{40, 16},{50, 18},{55, 20},{60, 24},{90, 25},{100, 26},{0, 30}
};
static const ProtobufCEnumValueIndex command__enum_values_by_name[30] =
{
  ...
  { "GET_CENTRAL_INFORMATION", 29 },
  { "GET_DEVICE_CONFIGURATION", 7 },
  { "GET_DEVICE_INFORMATION", 6 },
  { "GET_FIRMWARE_INFORMATION", 25 },
  { "GET_LOCALES", 22 },
  { "GET_STATE", 26 },
  { "INCOMING_CALL", 17 },
  { "ISSUE_MEDIA_CONTROL", 24 },
  { "KEEP_ALIVE", 20 },
  { "NONE", 0 },
