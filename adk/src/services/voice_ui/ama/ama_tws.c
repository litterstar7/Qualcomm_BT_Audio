...
{
    return ((ama_tws_data.current_role != tws_topology_role_none) &&
            ama_tws_data.role_state_initialised &&
            ama_tws_data.serverTask);
}
...
void AmaTws_DisconnectIfRequired(void)
{
    ...
    {
        DEBUG_LOG("AmaTws_DisconnectIfRequired: disconnecting");
