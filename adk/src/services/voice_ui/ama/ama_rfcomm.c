...
static void amaRfcomm_MessageHandler(Task task, MessageId id, Message message)
{
    ...
    DEBUG_LOG("amaRfcomm_MessageHandler id MESSAGE:%x", id);
    ...
    switch (id)
    {
        ...
        {
            DEBUG_LOG("AMA_RFCOMM AMA_RFCOMM_LOCAL_DISCONNECT_REQ");
        ...
        default:
            DEBUG_LOG("AMA_RFCOMM rfCommMessageHandler unknown MESSAGE:0x%x", id);
            break;
    }
}
