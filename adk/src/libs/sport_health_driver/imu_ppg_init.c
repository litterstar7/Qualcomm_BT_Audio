...
LOGGING_PRESERVE_MESSAGE_TYPE(imu_internal_messages_t)
LOGGING_PRESERVE_MESSAGE_TYPE(ppg_internal_messages_t)
LOGGING_PRESERVE_MESSAGE_TYPE(prox_internal_messages_t)
