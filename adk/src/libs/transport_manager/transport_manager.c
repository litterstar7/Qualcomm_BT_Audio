...
LOGGING_PRESERVE_MESSAGE_TYPE(transport_mgr_message_id_t)
LOGGING_PRESERVE_MESSAGE_TYPE(transport_manager_internal_t)
...
void TransportMgrConfigureSink(Sink snk)
{
    ...
    MessageStreamTaskFromSink(snk, transportMgrGetTransportTask());
}
