...
*/
inline static bool VmalOperatorMessage(uint16 opid, const void * send_msg, uint16 send_len,
                                            void * recv_msg, uint16 recv_len)
{
    return OperatorMessage(opid, (const uint16 *)send_msg, send_len, (uint16 *)recv_msg, recv_len);
}
