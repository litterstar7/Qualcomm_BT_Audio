...
typedef enum
{
    ...
    /*! send to itself after start data, it is used to handle concurrent DFU cases */
    UPGRADE_INTERNAL_START_PEER_CONCURRENT,

    /*! internal message used to delay the reboot of devices */
    UPGRADE_INTERNAL_DELAY_REBOOT,
