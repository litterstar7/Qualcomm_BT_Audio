...
{
    audio_mic_params monitor_mic = { .bias_config = BIAS_CONFIG_DISABLE,
...
static void connectAudioOutputs(void)
{
    ...
    audio_output_params_t output_params = { ANC_TUNING_MODE_SAMPLE_RATE, audio_output_tansform_connect };
    ...
    {
        AudioOutputAddSource(right, audio_output_primary_left);
    }
