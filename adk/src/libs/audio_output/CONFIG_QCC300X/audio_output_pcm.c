...
bool audioOutputPcmInitHardware(const audio_output_config_t* config)
{
    ...
    {
        audio_output_hardware_type_t type = config->mapping[audio_out].hardware_type;
        audio_output_hardware_instance_t instance = config->mapping[audio_out].hardware_instance;
