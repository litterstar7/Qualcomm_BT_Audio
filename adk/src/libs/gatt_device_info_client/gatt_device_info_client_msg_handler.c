...
static void handleGattManagerMsg(Task task, MessageId id, Message payload)
{
    ...
    GATT_DEVICE_INFO_CLIENT_DEBUG_INFO(("handleGattManagerMsg MESSAGE:0x%x\n", id));
...
static void handleInternalDeviceInfoMsg(Task task, MessageId id, Message msg)
{
    ...
    GATT_DEVICE_INFO_CLIENT_DEBUG_INFO(("handleInternalDeviceInfoMsg MESSAGE:0x%x\n", id));
...
{
    GATT_DEVICE_INFO_CLIENT_DEBUG_INFO(("deviceInfoClientMsgHandler MESSAGE:0x%x\n",id));
