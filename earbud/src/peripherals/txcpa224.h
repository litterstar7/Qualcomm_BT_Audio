...
#define TXCPA224_PS_SLEEP_PERIOD_5000    (0x03)

#define TXCPA224_PS_OFFSET_MAX           (150)
#define TXCPA224_PS_OFFSET_MIN           (120)
...
#define TXCPA224_FILTER_COEFF            (0x01)
#define TXCPA224_LIGHT_PULSE             (0x00)
...
enum
{
    PROXIMITY_INTERNAL_KEEP_ALIVE_TIMER,
