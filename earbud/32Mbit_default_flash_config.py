...

{
    ...
    "layout": [
        ...
        ("apps_p0",         {"capacity": 152 * 4 * 1024,  "authenticate": True, "src_file_signed": True}),
        ("apps_p1",         {"capacity": 208 * 4 * 1024,  "authenticate": False}),
        ...
        ("ro_cfg_fs",       {"capacity":  58 * 4 * 1024,  "authenticate": False}),
        ("ro_fs",           {"capacity":  71 * 4 * 1024,  "authenticate": False})
    ]
}
