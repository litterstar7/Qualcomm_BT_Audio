 ...
 ****************************************************************************/
/**
 * \file  cbops_sidetone_mix_op_extra.c
 * \ingroup cbops
 *
 * This file contains additional functions for cbops
 * multi-channel sidetone mixing operator.
 */
                                 ...
                                 unsigned threshold)
{
    cbops_op *op = create_multichan_sidetone_mix_op_base(1,           /* nr_channels */
                                                         ...
                                                         threshold,   /* threshold */
                                                         0);          /* no initial latency control via this api */
    if(NULL != op)
    {
                                                ...
                                                unsigned adjust_level)
{
    ...
    if(op != NULL)
    {
        ...
        /* Config params which are thresholds used for all of the
         * sidetone channels
         */
        params->max_samples = threshold;
        params->adjust_level = adjust_level;
