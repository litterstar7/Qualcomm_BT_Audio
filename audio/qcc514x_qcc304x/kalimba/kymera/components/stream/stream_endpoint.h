 ...
 */
ENDPOINT *stream_spdif_get_endpoint(CONNECTION_LINK con_id,
                                    ENDPOINT_DIRECTION dir,
                                    unsigned num_params,
                                    unsigned *params,
                                    bool *pending);
 ...
 *
 */
ENDPOINT *stream_operator_get_endpoint(unsigned int opid,
 ...
 *
 */
ENDPOINT *stream_file_get_endpoint(CONNECTION_LINK con_id,
                                   ENDPOINT_DIRECTION dir,
                                   unsigned num_params,
                                   unsigned *params);
#endif /* INSTALL_FILE */
 ...
 *
 */
ENDPOINT *stream_sim_file_get_endpoint(CONNECTION_LINK con_id,
                                       ENDPOINT_DIRECTION dir,
                                       unsigned num_params,
                                       unsigned *params);
...
ENDPOINT *stream_raw_buffer_get_endpoint(CONNECTION_LINK con_id,
                                         unsigned instance);
#endif /* INSTALL_RAW_BUFFER */
 ...
 * \param params a pointer to the creation parameters
 */
ENDPOINT *stream_a2dp_get_endpoint(CONNECTION_LINK con_id,
                                   ENDPOINT_DIRECTION dir,
                                   unsigned num_params,
                                   unsigned *params);
#endif /* CHIP_BASE_BC7 */
 ...
 */
INLINE_SECTION
static inline ENDPOINT *stream_shunt_get_endpoint(CONNECTION_LINK con_id,
                                                  ENDPOINT_DIRECTION dir,
                                                  unsigned num_params,
                                                  unsigned *params)
{
