...
#define OPMSG_UNSOLICITED_AANC_INFO_WORD_SIZE (8)
/*lint -e(773) allow unparenthesized*/
#define OPMSG_UNSOLICITED_AANC_INFO_CREATE(flags, ff_coarse_gain, ff_fine_gain, fb_coarse_gain, fb_fine_gain, ec_coarse_gain, ec_fine_gain) \
    (uint16)((flags) & 0xffff), \
    (uint16)((flags) >> 16), \
    ...
    (uint16)(ec_fine_gain)
#define OPMSG_UNSOLICITED_AANC_INFO_PACK(opmsg_unsolicited_aanc_info_ptr, flags, ff_coarse_gain, ff_fine_gain, fb_coarse_gain, fb_fine_gain, ec_coarse_gain, ec_fine_gain) \
    do { \
...
#define OPMSG_UNSOLICITED_AANC_INFO_MARSHALL(addr, opmsg_unsolicited_aanc_info_ptr) memcpy((void *)(addr), (void *)(opmsg_unsolicited_aanc_info_ptr), 8)
#define OPMSG_UNSOLICITED_AANC_INFO_UNMARSHALL(addr, opmsg_unsolicited_aanc_info_ptr) memcpy((void *)(opmsg_unsolicited_aanc_info_ptr), (void *)(addr), 8)
