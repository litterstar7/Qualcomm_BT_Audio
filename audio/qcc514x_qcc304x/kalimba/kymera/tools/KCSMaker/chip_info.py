...
class chip_info(object):
    ...
    _supported_chips_list     = [A7DA_KAS, CRESCENDO, STRE, STREPLUS]
    _pm_octet_addressing_list = [CRESCENDO, A7DA_KAS, STRE, STREPLUS]
    _dm_octet_addressing_list = [CRESCENDO, STRE, STREPLUS]
    _kal_arch4_list           = [CRESCENDO, STRE, STREPLUS]
    _kal_arch5_list           = [A7DA_KAS]
    _minim_list               = [A7DA_KAS, CRESCENDO, STRE, STREPLUS]

    _kld_list                 = [CRESCENDO, STRE, STREPLUS]
    _mark_code_section_type   = [CRESCENDO, STRE, STREPLUS]

    # Get this from http://wiki/ChipVersionIDs
    # DSP_ID in A7DA chip is a special case, see B-159218 if interested
    _dsp_id_dict = {GORDON: 0xC9, A7DA_KAS: 0x60A0, CRESCENDO: 0x46, STRE: 0x49, STREPLUS: 0x4B}
    ...
    _crt_lib_name = {A7DA_KAS: "a7da", CRESCENDO : "csra68100_audio", STRE : "QCC302x_audio", STREPLUS : "QCC514x_audio"}
