...
.CONST $fbc.PEAK_OUTPUT                   MK1 * 10;
.CONST $fbc.PUBLIC_STRUCT_SIZE                  11;
.CONST $fbc.INT_VAR                       MK1 * 11;
...
.CONST $fbc.STRUCT_SIZE                   ($fbc.PUBLIC_STRUCT_SIZE + 42);
...
.CONST $fbc.STRUCT_SIZE.EXT               ($fbc.PUBLIC_STRUCT_SIZE + 51);
